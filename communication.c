...
int connectToWallaby() //returns -1 if connection fails, -2 if not in client mode
{
    ...
    sprintf(set_ssid, "wpa_cli set_network 0 ssid '3312-wallaby'");
    sprintf(set_psk, "wpa_cli set_network 0 psk '2ee62f00'");
